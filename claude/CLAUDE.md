...
A Claude skill system that turns messy software ideas into clear implementation specs.
...
Use `contour-mind` to turn a vague software idea into a structured spec.
Use `contour-verify` to review that spec for completeness and buildability.
